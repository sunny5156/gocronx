...
type Task struct {
	...
	Name             string               `json:"name" xorm:"varchar(255) notnull"`                           // 任务名称
	...
	Command          string               `json:"command" xorm:"varchar(1000) notnull"`                        // URL地址或shell命令
	...
	Tag              string               `json:"tag" xorm:"varchar(50) notnull default ''"`
