<template>
  <el-container>
    ...
    <el-main>
      ...
      <el-form ref="form" :model="form" :rules="formRules" label-width="150px" size="mini">
        <h3>邮件服务器配置</h3>
        <el-row>
          <el-col :span="12">
        ...
        <el-button icon="el-icon-plus" size="mini" type="primary" @click="createUser">新增用户</el-button>
        <br><br>
        <h3>通知用户</h3>
        <el-tag
